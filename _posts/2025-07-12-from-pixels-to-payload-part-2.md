...
tags: [dll-hijacking, windows, explorer, steganography, procmon, lolbins]
author: yuriibe
---
...
![procmon](/writeup-vault/experimental/from-pixels-to-payload/images/procmon.png)
...
![MovingDLL](/writeup-vault/experimental/from-pixels-to-payload/images/movingOldDll.png)

- Moved our own DLL into the System32 folder

![system32](/writeup-vault/experimental/from-pixels-to-payload/images/sytem32.png)
...
![proof](/writeup-vault/experimental/from-pixels-to-payload/images/proof.png)
