...
tags: [steganography, lsb, in-memory, shellcode, python, cpp, dll-hijacking]
author: yuriibe
---
...
**Embedding Phase**
![Embedding Flowchart](/writeup-vault/experimental/from-pixels-to-payload/images/flowChartEmbed.drawio.png)

**Extraction Phase**
![Extraction Flowchart](/writeup-vault/experimental/from-pixels-to-payload/images/extract.drawio.png)
...
![payload](/writeup-vault/experimental/from-pixels-to-payload/images/msfvenom_textbox.png)
...
![messagebox](/writeup-vault/experimental/from-pixels-to-payload/images/messagebox.png)
