...
tags: [adguard, dns, raspberry-pi, privacy, homelab, telemetry, docker, fritzbox]
author: yuriibe
image:
  path: /writeup-vault/experimental/Your-Smart-Home-Is-Snitching-On-You/query-log.png
---
...
![Query log showing multiple DNS requests in six minutes](/writeup-vault/experimental/Your-Smart-Home-Is-Snitching-On-You/query-log.png)
...
![Fritz!Box advanced network settings](/writeup-vault/experimental/Your-Smart-Home-Is-Snitching-On-You/router_advanced_settings.png)

![Local DNS server field set to Raspberry Pi IP](/writeup-vault/experimental/Your-Smart-Home-Is-Snitching-On-You/local-dns-ip.png)
...
![AdGuard blocklist settings page](/writeup-vault/experimental/Your-Smart-Home-Is-Snitching-On-You/adguard-blocklist.png)

![Add custom blocklist modal](/writeup-vault/experimental/Your-Smart-Home-Is-Snitching-On-You/blocklists-modal.png)
...
![AdGuard Home dashboard statistics](/writeup-vault/experimental/Your-Smart-Home-Is-Snitching-On-You/dashboard-stats.png)
