...
tags: [security, cve, pentesting, grafana]
author: yuriibe
published: true
canonical_url: https://yuriibe.github.io/writeup-vault/posts/grafana-passwords-poor-life-choices/
image:
  path: https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/Expanding_Brain_Meme.jpg
---
...
![path traversal proof](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image.png)
...
![grafana.ini contents](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%201.png)
...
![Guy tapping head meme](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/Guy_tapping_head_meme.jpg)
...
![decrypted password](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%203.png)
...
![exploit script](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%204.png)
...
![grafana login success](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%205.png)
...
![new dashboard panel](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%206.png)

![query editor](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%207.png)

```sql
SELECT @@version;
```

![version query](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%208.png)
...
![database query](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%209.png)
...
![insert backdoor](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%2010.png)
...
![verify backdoor](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%2011.png)
...
![zabbix dashboard](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%2012.png)
...
![create script](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%2013.png)
...
![shell as zabbix](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%2014.png)
...
![root access](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/image%2015.png)
...
![expanding brain meme](https://yuriibe.github.io/writeup-vault/security-writeups/Grafana,%20Passwords,%20and%20Poor%20Life%20Choices/screenshots/Expanding_Brain_Meme.jpg)
